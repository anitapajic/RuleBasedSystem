...
public class TokenUtils {
    ...
    public String generateToken(User user) {
        ...
        // moguce je postavljanje proizvoljnih podataka u telo JWT tokena pozivom funkcije .claim("key", value),
    ...
    private String generateAudience() {
        ...
        //	Moze se iskoristiti org.springframework.mobile.device.Device objekat za odredjivanje tipa uredjaja sa
        //	kojeg je zahtev stigao.
    ...
    public String getToken(HttpServletRequest request) {
        ...
        if (authHeader != null && authHeader.startsWith("Bearer ")) {
            // preuzimamo samo token (vrednost tokena je nakon "Bearer " prefiksa)
